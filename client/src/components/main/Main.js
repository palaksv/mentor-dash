      ...
      <div className="main__container">
        ...
        <div className="main__cards">
          ...
          <div className="card">
            ...
            ></i>
            <div className="card_inner">
              <p className="text-primary-p">Placement statistics</p>
          ...
          <div className="card">
            ...
            ></i>
            <div className="card_inner">
              <p className="text-primary-p">Discussion Forum</p>
              <span className="font-bold text-title">Tap here</span>
            </div>
          </div>
        </div>
